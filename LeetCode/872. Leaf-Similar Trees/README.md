 ...
 */
class Solution {
    static void dfs(TreeNode tree, ArrayList list) {
        if(tree == null) return;
    ...
    public boolean leafSimilar(TreeNode root1, TreeNode root2) {
        ArrayList<Integer> r1Nodes = new ArrayList<>();
        ArrayList<Integer> r2Nodes = new ArrayList<>();
        dfs(root1, r1Nodes);
        dfs(root2, r2Nodes);
        return r1Nodes.equals(r2Nodes);
